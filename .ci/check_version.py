...
Check version number in setup.json and aiida_twinpy/__init__.py and make sure
they match.
"""
...
import aiida_twinpy  # pylint: disable=wrong-import-position
version = aiida_twinpy.__version__
