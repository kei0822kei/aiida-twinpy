...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.input('metadata.options.parser_name', valid_type=six.string_types, default='twinpy')
        ...
        spec.output('twinpy', valid_type=SinglefileData, help='diff between file1 and file2.')
